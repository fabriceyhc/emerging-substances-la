...
"    else:",
"        # A Colab runtime persists across cell re-runs within one session,",
"        # so a checkout from an earlier run stays right where it is --",
"        # pull rather than trust it, or a file added by a later push (e.g.",
"        # a new results/*.csv this notebook now reads) silently 404s until",
"        # the runtime is fully reset.",
"        !git -C {REPO} pull -q",
