...
- **Position on the cause line.** The ME writes one combined string —
  ...
  named first; `mean_rank_pct` runs 0 (always first) to 1 (always last). Both
  are computed only on multi-substance lines, so a solo mention cannot count
  as "named first".

| | n (2025) | alone | with fentanyl | named first | mean rank | verdict |
|---|---|---|---|---|---|---|
| Fentanyl | 1101 | 15% | — | 82% | 0.13 | principal driver |
| Cocaine | 455 | 26% | 49% | 44% | 0.43 | principal driver |
| Methamphetamine | 1345 | 37% | 49% | 16% | 0.75 | independent |
| Alprazolam | 110 | 1% | 75% | 21% | 0.64 | adulterant/marker |
| PCP | 137 | 0% | 51% | 2% | 0.90 | secondary/incidental |
| **Lidocaine** | **17** | **0%** | **100%** | **0%** | **0.93** | **adulterant/marker** |

Lidocaine is a cutting agent. Every one of its 17 recent deaths names
fentanyl, none names it first, and it sits at 0.93 on the cause line. The
right headline is "the fentanyl supply is being cut differently", not
"lidocaine is killing people".
